...
async def on_message(message):
    ...
    if message.content.startswith('!motivate'):
        await message.channel.send("Remember your parents are your best source of motivation")
        ...
        await message.channel.send('Follow this link for the best gaming video: ' + random.choice(links_bb))
...
client.run('ODEzNzg4MDIzNzM2NjMxMzA4.YDUZKA.Do2S6VOBlieOUHya3mIkzXp5dHg')